...
module.exports = (bot) => async (msg, match) => {
  ...
  const tickets_number = await lottery.calculate_tickets_number_for_user_and_round(user, round);
  let message = `🎟 You have ${tickets_number} tickets for the current /lottery round:\n\n`;
